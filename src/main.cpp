...
int64 nChainStartTime = 1461600697;
...
const string strMessageMagic = "wenwancoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in wenwancoin
    bool fStrictPayToScriptHash = true; // Always active in wenwancoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "wenwancoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "PoW base target is wenwancoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 282034 : 282034;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0x37c600feaf7dd0eb30a5a6326cb6074ce1adbc3661503d63db7b2d12e69f83d7"));
...
unsigned char pchMessageStart[4] = { 0xcd, 0xfb, 0xda, 0xdb };
